...
<template>
  <div class="relative">
    <slot :is-open="isOpen">
      ...
      >
        <div
          class="flex items-center justify-between text-gray-700 w-full text-sm border-r-0 rounded-l cursor-pointer"
          :class="{
            'bg-white border border-gray-400 dark:bg-gray-800 dark:border-gray-700':
              !isOpen,
        ...
        >
          <BaseButton
            ...
            :class="[
              ...
              dropdownBorder,
              {
                'border border-gray-400 hover:bg-gray-200 shadow-none bg-white dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-900':
                  !isOpen,

<template>
  <div class="border border-gray-400 rounded-md overflow-hidden">
    ...
    <header class="border-b p-1 bg-gray-200">
      <div class="flex flex-wrap gap-1" v-if="editor">
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{
            'bg-slate-600 text-white': editor.isActive('heading', { level: 1 }),
          }"
        >
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{
            'bg-slate-600 text-white': editor.isActive('heading', { level: 2 }),
          }"
        >
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{
            'bg-slate-600 text-white': editor.isActive('heading', { level: 3 }),
          }"
        >
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{
            'bg-slate-600 text-white': editor.isActive('heading', { level: 4 }),
          }"
        >
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{
            'bg-slate-600 text-white': editor.isActive('heading', { level: 5 }),
          }"
        >
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{
            'bg-slate-600 text-white': editor.isActive('heading', { level: 6 }),
          }"
        >
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{ 'bg-slate-600 text-white': editor.isActive('bulletList') }"
        >
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{ 'bg-slate-600 text-white': editor.isActive('orderedList') }"
        >
        ...
        <button
          ...
          class="bg-gray-100 border p-2 rounded-sm text-slate-600 w-7 h-7 flex items-center justify-center text-xs"
          :class="{ 'bg-slate-600 text-white': editor.isActive('blockquote') }"
        >
